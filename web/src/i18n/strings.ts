...
export const strings = {
  ...
  adminAiIntro: "Choose which models power Ficina — self-hosted, or your own API key.",
  adminAddProvider: "Add provider",
  adminNoProviders: "No providers yet. Add one to turn on AI features.",
  adminManage: "Manage",
  adminDefaultBadge: "Default",
  adminMakeDefault: "Make default",
  adminProvidersError: "Couldn't load providers.",
  providerNew: "Add provider",
  providerEdit: "Edit provider",
  providerKind: "Provider",
  kindOllama: "Ollama (self-hosted)",
  kindOpenai: "OpenAI",
