...
import { Calendar, FileText, FolderClosed, Mail, MessagesSquare, Video } from "lucide-react";
...
export const modules: ModuleDef[] = [
  ...
  { id: "drive", path: "/drive", label: strings.moduleDrive, Icon: FolderClosed, enabled: false },
  { id: "docs", path: "/docs", label: strings.moduleDocs, Icon: FileText, enabled: false },
];
