//! Identity configuration (`FICINA_IDENTITY_*`), following the same
//! env-var convention as `ficina-smtp`/`ficina-imap`. Token lifetimes and
...
pub const ENV_ISSUER: &str = "FICINA_IDENTITY_ISSUER";
/// Env var for the access-token lifetime, in seconds.
pub const ENV_ACCESS_TTL: &str = "FICINA_IDENTITY_ACCESS_TTL_SECS";
/// Env var for the refresh-token lifetime, in seconds.
pub const ENV_REFRESH_TTL: &str = "FICINA_IDENTITY_REFRESH_TTL_SECS";
/// Env var for the authorization-code lifetime, in seconds.
pub const ENV_CODE_TTL: &str = "FICINA_IDENTITY_CODE_TTL_SECS";
/// Env var for the argon2id memory cost, in KiB.
pub const ENV_ARGON2_M: &str = "FICINA_IDENTITY_ARGON2_M_KIB";
/// Env var for the argon2id time cost (iterations).
pub const ENV_ARGON2_T: &str = "FICINA_IDENTITY_ARGON2_T";
/// Env var for the argon2id parallelism (lanes).
pub const ENV_ARGON2_P: &str = "FICINA_IDENTITY_ARGON2_P";
...
impl IdentityConfig {
    ...
    ///
    /// # Errors
    /// [`ConfigError::Missing`] if `FICINA_IDENTITY_ISSUER` is unset;
