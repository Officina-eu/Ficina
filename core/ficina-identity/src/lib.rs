//! # ficina-identity — the credential authority
//!
//! Ficina's single source of truth for *who* a request is: argon2id
//! passwords, TOTP 2FA, opaque revocable tokens, and an OpenID Connect /
//! OAuth 2.0 provider (Ficina-as-IdP). SMTP AUTH, IMAP/POP3 `LOGIN`, and
...
use ficina_store::{Store, StoreError, TenantId, UserId};
