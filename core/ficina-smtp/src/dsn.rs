...
pub fn compose(
    ...
    let boundary = format!("=_ficina_dsn_{original_id}");
...
mod tests {
    ...
    fn dsn_has_report_structure_and_null_sender_semantics() {
        ...
        assert!(dsn.contains("From: Mail Delivery System <MAILER-DAEMON@mx.ficina.test>"));
        ...
        assert!(dsn.contains("Reporting-MTA: dns; mx.ficina.test"));
