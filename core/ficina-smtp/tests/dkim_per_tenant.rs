...
use ficina_auth_mail::dkim::{self, DkimResult, Message};
use ficina_auth_mail::resolver::fixture::FixtureResolver;
use ficina_smtp::authmail::{AuthMail, SigningConfig};
...
async fn per_tenant_key_signs_and_validates_not_the_file_key() {
    ...
    let auth = AuthMail::disabled("mail.ficina.test")
