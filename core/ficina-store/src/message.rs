...
use ficina_auth_mail::dkim::Message;
...
Authentication-Results: mx.ficina.test; spf=pass smtp.mailfrom=alice@example.com; \
...
Hello there, this is the body.\r\n";
    ...
    fn authentication_results_authserv_id_is_not_a_method() {
        let (spf, dkim, dmarc) =
            parse_authentication_results("mx.ficina.test; spf=fail; dmarc=fail");
