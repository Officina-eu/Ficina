//! # ficina-imap — IMAP4rev2/rev1 + POP3 compatibility shims
//!
//! A thin protocol translator over [`ficina_store::AccountStore`]: JMAP is
//! Ficina's native protocol (ADR 0001), and these shims let the installed
//! base of IMAP/POP3 clients reach a Ficina mailbox unchanged. Every
