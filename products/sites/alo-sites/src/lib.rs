...
//! or anything authenticated — that is `alo-jmap` over `alo-store`. It talks
//! to `platform/alo-store` only (types today; snapshot reads when the service
//! lands) and never to another product.
//!
